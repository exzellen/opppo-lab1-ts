...
export default class List {
	...
	print() {
		if (this.isEmpty()) console.log("Список пуст.", "\n");
	...
	deleteNode(serNode) {
		if (this.isEmpty() || serNode == null) return;
	...
	delete(...args) {
		...
		while (true) {
			...
			else remNode = remNode.next;

			if (!remNode || flag) return;

			if (remNode == this.tail) flag = true;
		}
	}
}